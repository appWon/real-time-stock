...
import { CoinListContext, Coin } from '@/lib/contexts/CoinList';
...
const SearchBar: FC = () => {
  ...
  const { coinList, setSearchCoinList } = useContext(CoinListContext);
  ...
  const handleSelectCoin = async (selectCoin: string) => {
    ...
    setSearchCoinList(coinList => [...coinList, ...data]);
  };
